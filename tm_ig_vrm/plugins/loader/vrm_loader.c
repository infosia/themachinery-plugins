...
#define TM_IG_VRM_API_NAME "tm_ig_vrm_api"
...
TM_DLL_EXPORT void tm_load_plugin(struct tm_api_registry_api *reg, bool load)
{
    ...
    tm_set_or_remove_api(reg, load, TM_IG_VRM_API_NAME, tm_ig_vrm_api);
    ...
    if (load)
        tm_asset_io_api->add_asset_io(tm_ig_vrm_api->io_interface());
    else
        tm_asset_io_api->remove_asset_io(tm_ig_vrm_api->io_interface());
}
