...
solve_chain_forwards_with_target_rotation(struct chain_t* chain)
{
    ...
    {
        ik_vec3_static_div_scalar(target.position.f, (ikreal_t)average_count);
...
solve_chain_forwards_with_constraints(struct chain_t* chain)
{
    ...
    {
        ik_vec3_static_div_scalar(target_position.f, (ikreal_t)average_count);
    }
...
recurse_into_children(struct chain_t* chain)
{
    ...
    if (average_count > 0)
    {
        ik_quat_static_div_scalar(average_rotation.f, (ikreal_t)average_count);
